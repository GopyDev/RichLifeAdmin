                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title">
                                <h1>Create Park or Amenity <small></small></h1>
                                <ol class="breadcrumb">
                                    <li><a href="#"><i class="fa fa-home"></i></a></li>
                                    <li class="active">Create Park or Amenity</li>
                                </ol>
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-card margin-b-30">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title"> Please enter the detail information below</h4>
                                ...
                                <div class="panel-body">
                                    <form class="form-horizontal" enctype="multipart/form-data" method="POST">
                                        <div class="form-group"><label class="col-lg-2 control-label">Title</label>
                                            <div class="col-lg-10"><input type="text" placeholder="Title" id="subtitle" name="subtitle" class="form-control" required> 
                                            </div>
                                        </div>
                                        <div class="form-group"><label class="col-lg-2 control-label">Sub Text</label>
                                            <div class="col-lg-10"><textarea type="text" placeholder="Sub Text" id="subtext" name="subtext" class="form-control" required></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group"><label class="col-lg-2 control-label"></label>
                                            <div class="col-lg-10"><img src="" alt="Picture" class="img-circle" width="120" height="120" id="evtimg" name="evtimg" style="display:none"></div>
                                        </div>
                                        ...
                                        <div class="form-group"><label class="col-lg-2 control-label">Date and Time</label>
                                            <div class="col-lg-10">
                                                <input type="text" placeholder="Set date and time" class="form-control" id="datetime" name="datetime" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-lg-offset-2 col-lg-10">
