                        ...
                        <div class="col-md-12">
                            <div class="panel panel-card margin-b-30 ">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">Below is a list of the events</h4>
                                ...
                                <div class="panel-body">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <?php for($i=0;$i<$row;$i++){?>
                                            <tr>
                                                <td><?php echo $allevent[$i]['name'];?></td>
                                                <td><?php echo $allevent[$i]['title'];?></td>
                                                <td><?php echo $allevent[$i]['location'];?></td>
                                                <td><?php echo $allevent[$i]['category'];?></td>
                                                <td><a href="<?php echo "event_edit.php?eventid=".base64_encode($allevent[$i]['eventid']);?>" class="btn btn-warning btn-3d">Edit</a>
                                                    <a href="<?php echo "event_delete.php?eventid=".base64_encode($allevent[$i]['eventid']);?>" class="btn btn-danger btn-3d" onclick="return confirmDelete();">Delete</a>
                                                </td>
                                            </tr>
                                            <?php }?>
                                        </tbody>
                                ...
                                <a href="createEvent.php" class="btn btn-primary btn-3d">Create a new event</a>
                            </div>
                        </div><!--end .col-->
                    </div>
                </div> 
