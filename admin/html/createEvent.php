                                ...
                                <div class="panel-body">
                                    <form class="form-horizontal" enctype="multipart/form-data" method="POST" novalidate>
                                        ...
                                        <div class="form-group" id="evtname"><label class="col-lg-2 control-label">Event Name</label>
                                            <div class="col-lg-10"><input type="text" placeholder="Event Name" id="name" name="name" class="form-control" required> 
                                            </div>
                                        </div>
                                        <div class="form-group" id="evttitle"><label class="col-lg-2 control-label">Event Sub Title</label>
                                            <div class="col-lg-10"><input type="text" placeholder="Event Sub Title" id="subtitle" name="subtitle" class="form-control" required> 
                                            </div>
                                        </div>
                                        <div class="form-group" id="evttext"><label class="col-lg-2 control-label">Event Sub Text</label>
                                            <div class="col-lg-10"><textarea type="text" placeholder="Event Sub Text" id="subtext" name="subtext" class="form-control" required></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group" id="payment"><label class="col-lg-2 control-label">Payment</label>
                                            <div class="col-lg-10"><input type="checkbox" value="1" name="pay"></div>
                                        </div>
                                        <div class="form-group" id="reservation"><label class="col-lg-2 control-label">Reservation</label>
                                            <div class="col-lg-10"><input type="checkbox" value="1" name="reserve"></div>
                                        </div>
                                        <div class="form-group" id="evtimage"><label class="col-lg-2 control-label">Event Image</label>
                                            <div class="col-lg-10">
                                                ...
                                                <!--<a href="" type="button" class="btn btn-danger delete"><i class="fa fa-fw fa-trash"></i>
                                                    <span>Delete Image</span>
                                                </a>-->
                                            </div>
                                        </div>
                                        <div class="form-group" id="evtimgcontent"><label class="col-lg-2 control-label"></label>
                                            <div class="col-lg-10"><img src="" alt="Picture" class="img-circle" width="80" height="80" id="evtimg" name="evtimg" style="display:none"></div>
                                        </div>
                                        <div class="form-group" id="evticoncontent"><label class="col-lg-2 control-label">Event Icon</label>
                                            <div class="col-lg-10">
                                                <img src="" alt="Icon" class="img-circle" width="35" height="35" id="evticon" name="evticon" style="display:none">
                                                <span class="btn btn-success fileinput-button"><i class="fa fa-fw fa-plus"></i>
                                                <span>Add icon... </span>
                                        ...
                                        <div class="form-group" id="evtlocation"><label class="col-lg-2 control-label">Location</label>
                                            ...
                                            <div class="col-lg-10"><input type="text" placeholder="Position" id="position" name="position" disabled class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group" id="evtdate"><label class="col-lg-2 control-label">Date and Time</label>
                                            <div class="col-lg-10">
                                                <input type="text" placeholder="Set date and time" class="form-control" id="datetime" name="datetime">
                                            </div>
                                        </div>
