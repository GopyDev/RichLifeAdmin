                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title">
                                <h1>Venue edit<small></small></h1>
                                <ol class="breadcrumb">
                                    <li><a href="#"><i class="fa fa-home"></i></a></li>
                                    <li class="active">Venue edit</li>
                                </ol>
                            </div>
                        </div>
                    </div><!-- end .page title-->
                                ...
                                <div class="panel-body">
                                    <form class="form-horizontal" enctype="multipart/form-data" method="POST">
                                        <div class="form-group"><label class="col-lg-2 control-label">Venue Title</label>
                                            <div class="col-lg-10"><input type="text" placeholder="Venue Name" id="name" name="name" class="form-control" value="<?php  echo $venues[0]['title']; ?>"> 
                                            </div>
                                        </div>
                                        <div class="form-group"><label class="col-lg-2 control-label">Venue Description</label>
                                            <div class="col-lg-10"><textarea type="text" placeholder="Venue description" id="subtext" name="subtext" class="form-control"><?php  echo $venues[0]['text']; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group"><label class="col-lg-2 control-label">Open Date</label>
                                            <div class="col-lg-10">
                                                <input type="text" placeholder="Set open date" class="form-control" id="fdate" name="fdate" value="<?php  echo $venues[0]['fromdate']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group"><label class="col-lg-2 control-label">Expire Date</label>
                                            <div class="col-lg-10">
                                                <input type="text" placeholder="Set expire date" class="form-control" id="tdate" name="tdate" value="<?php  echo $venues[0]['todate']; ?>">
                                            </div>
                                        </div>
